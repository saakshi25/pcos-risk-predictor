...
st.write("Enter patient health parameters to estimate PCOS risk.")
...
if st.button("Predict Risk"):
    ...
    for feature in expected_features:
        input_df.loc[0, feature] = user_data.get(feature, 0)
    ...
    tips = [
        ...
        "Include omega-3 foods like nuts.",
        ...
        "Consult doctors for hormonal checkups."
    ]
